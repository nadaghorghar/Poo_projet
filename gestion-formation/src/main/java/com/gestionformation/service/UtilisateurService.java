...
public class UtilisateurService {
    ...
    public Utilisateur findById(Integer id) { return utilisateurRepository.findById(id).orElseThrow(); }
    ...
    public void delete(Integer id) { utilisateurRepository.deleteById(id); }
}